...
This could be considered as a minimal set of conventions [approved by José Valim](https://elixirforum.com/t/the-elixir-style-guide/2534/7) 

(forked from [lexmax's style guide](https://github.com/lexmag/elixir-style-guide))


_You might also want to check out more broader and detailed community driven style guide for Elixir by [Christopher Adams](https://github.com/christopheradams/elixir_style_guide)_
